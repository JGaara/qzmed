                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tfoot>
	                                    <tr>
											<td colspan="9">第${pager.getCurrentPage()}页 共${pager.getTotalPages()}页
    ...
    <script>
        ...
        function first(obj){
        	...
        	if(1 < currentPage){
        		...
        		window.location.href = "${pageContext.request.contextPath}/error?m=first&c="+currentPage;
        	}else{
        	alert("已经是首页了");
        	}
        }
        function previous(obj){
        	...
        	if(1 < currentPage){
        		...
        		window.location.href = "${pageContext.request.contextPath}/error?m=previous&c="+currentPage;
        		//toPage(url, turl);
        	}else{
        	alert("已经是最前一页了");
        	}
        ...
        function next(obj,totalPages){
        	...
        	if(currentPage < totalPages){
        		var url = "${pageContext.request.contextPath}/page?m=next&c="+currentPage;
        		window.location.href = "${pageContext.request.contextPath}/error?m=next&c="+currentPage;
        		//toPage(url, turl)
        	}else{
        	alert("已经是最后一页了");
        	}
        ...
        function last(obj,totalPages){
        	...
        	if(currentPage < totalPages){
        		...
        		window.location.href = "${pageContext.request.contextPath}/error?m=last&c="+currentPage;
        		//toPage(url, turl);
        	}else{
        	alert("已经是尾页了");
        	}
