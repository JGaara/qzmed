...
<body>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        <!-- 添加数据 -->
                                        <c:forEach items="${conList}" varStatus="i" var="item" step="1"> 
										<tr>  
    ...
    <script>
        ...
        function first(obj){
        	...
        	window.location.href = "${pageContext.request.contextPath}/convert?m=first&c="+currentPage;
        	//toPage(url, turl);
        	}else{
        	alert("已经是首页了");
        	}
        ...
        function previous(obj){
        	...
        	window.location.href = "${pageContext.request.contextPath}/convert?m=previous&c="+currentPage;
        	//alert(turl);
        	//toPage(url, turl);
        	}else{
        	alert("已经是最前一页了");
        ...
        function next(obj,totalPages){
        	...
        	window.location.href = "${pageContext.request.contextPath}/convert?m=next&c="+currentPage.toString();
        	//toPage(url, turl);
        	}else{
        	alert("已经是最后一页了");
        	}
        ...
        function last(obj,totalPages){
        	...
        	window.location.href = "${pageContext.request.contextPath}/convert?m=last&c="+currentPage;
        	//toPage(url, turl);
        	}else{
        	alert("已经是尾页了");
        	}
