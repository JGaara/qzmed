...
@XmlRootElement(name = "DEHFareDetail")
@XmlType(propOrder = { "HospitalCode", "HospitalLicense", "Content" })
public class DEHFareDetail {
	private String HospitalCode;
	private String HospitalLicense;
	private DEHFareDetailContent Content;
	...
	public DEHFareDetailContent getContent() {
		return Content;
	}
	public void setContent(DEHFareDetailContent content) {
		Content = content;
	}
	...
	public static Original getOriginal(DEHFareDetailContent content, String serialNum) {
		DEHFareDetail dec = new DEHFareDetail();
		//这个编码用视图中。
		...
		o.setBusinessTypeNo(CommonCode.BusinessTypeZYSFMX);
