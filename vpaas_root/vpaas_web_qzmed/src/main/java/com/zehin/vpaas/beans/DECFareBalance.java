...
@XmlRootElement(name = "DECFareBalance")
@XmlType(propOrder = { "HospitalCode", "HospitalLicense", "Content" })
public class DECFareBalance {
	private String HospitalCode;
	private String HospitalLicense;
	private DECFareBalanceContent Content;
	...
	public DECFareBalanceContent getContent() {
		return Content;
	}
	public void setContent(DECFareBalanceContent content) {
		Content = content;
	}
	...
	public static Original getOriginal(DECFareBalanceContent content, String serialNum) {
		DECFareBalance dec = new DECFareBalance();
		//这个编码用视图中。
		...
		o.setBusinessTypeNo(CommonCode.BusinessTypeMZFYJS);
