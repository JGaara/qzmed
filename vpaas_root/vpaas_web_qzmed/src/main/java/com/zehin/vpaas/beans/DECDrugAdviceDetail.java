...
@XmlRootElement(name = "DECDrugAdviceDetail")
@XmlType(propOrder = { "HospitalCode", "HospitalLicense", "Content" })
public class DECDrugAdviceDetail {
	private String HospitalCode;
	private String HospitalLicense;
	private DECDrugAdviceDetailContent Content;
	...
	public DECDrugAdviceDetailContent getContent() {
		return Content;
	}
	public void setContent(DECDrugAdviceDetailContent content) {
		Content = content;
	}
	...
	public static Original getOriginal(DECDrugAdviceDetailContent content, String serialNum) {
		DECDrugAdviceDetail dec = new DECDrugAdviceDetail();
		//这个编码用视图中。
		...
		o.setBusinessTypeNo(CommonCode.BusinessTypeMZCFMX);
