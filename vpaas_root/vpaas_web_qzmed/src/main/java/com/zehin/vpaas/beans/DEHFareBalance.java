...
@XmlRootElement(name = "DEHFareBalance")
@XmlType(propOrder = { "HospitalCode", "HospitalLicense", "Content" })
public class DEHFareBalance {
	private String HospitalCode;
	private String HospitalLicense;
	private DEHFareBalanceContent Content;
	...
	public DEHFareBalanceContent getContent() {
		return Content;
	}
	public void setContent(DEHFareBalanceContent content) {
		Content = content;
	}
	/**
	 * 
	...
	public static Original getOriginal(DEHFareBalanceContent content, String serialNum) {
		DEHFareBalance dec = new DEHFareBalance();
		//这个编码用视图中。
		...
		o.setBusinessTypeNo(CommonCode.BusinessTypeZYFYJS);
