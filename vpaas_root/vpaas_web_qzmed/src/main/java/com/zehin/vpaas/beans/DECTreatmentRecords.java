...
@XmlRootElement(name = "DECTreatmentRecords")
@XmlType(propOrder = { "HospitalCode", "HospitalLicense", "Content" })
public class DECTreatmentRecords {
	private String HospitalCode;
	private String HospitalLicense;
	private DECTreatmentRecordsContent Content;
	...
	public DECTreatmentRecordsContent getContent() {
		return Content;
	}
	public void setContent(DECTreatmentRecordsContent content) {
		Content = content;
	}
	/**
	 * 
	...
	public static Original getOriginal(DECTreatmentRecordsContent content, String serialNum) {
		DECTreatmentRecords dec = new DECTreatmentRecords();
		//这个编码用视图中。
		...
		o.setBusinessTypeNo(CommonCode.BusinessTypeMZJZJL);
