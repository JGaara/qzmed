...
@XmlRootElement(name = "DECDrugAdvice")
@XmlType(propOrder = { "HospitalCode", "HospitalLicense", "Content" })

public class DECDrugAdvice {
	private String HospitalCode;
	private String HospitalLicense;
	private DECDrugAdviceContent Content;
	...
	public DECDrugAdviceContent getContent() {
		return Content;
	}
	public void setContent(DECDrugAdviceContent content) {
		Content = content;
	}
	...
	public static Original getOriginal(DECDrugAdviceContent content, String serialNum) {
		DECDrugAdvice dec = new DECDrugAdvice();
		//这个编码用视图中。
		...
		o.setBusinessTypeNo(CommonCode.BusinessTypeMZCFZB);
