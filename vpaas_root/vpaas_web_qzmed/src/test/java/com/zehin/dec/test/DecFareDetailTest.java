...
public class DecFareDetailTest {
	
	@Resource
	private DECFareDetailContentServiceImpl decFareDetailContentService;
...
/*	@Test
	...
	*/
	...
	public void testFindAll() {
		DECFareDetailContentMapper drcm = (DECFareDetailContentMapper) 
				SpringBeanUtil.getApplicationContext().getBean(DECFareDetailContentMapper.class);
		decFareDetailContentService.setMapper(drcm);
		List<DECFareDetailContent> decRegContent = decFareDetailContentService.findAll(new DECFareDetailContent());
