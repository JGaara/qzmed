...
public class DecFareBalanceTest {
	
	@Resource
	private DECFareBalanceContentServiceImpl decFareBalanceContentService;
...
/*	@Test
	...
	*/
	...
	public void testFindAll() {
		DECFareBalanceContentMapper drcm = (DECFareBalanceContentMapper) 
				SpringBeanUtil.getApplicationContext().getBean(DECFareBalanceContentMapper.class);
		decFareBalanceContentService.setMapper(drcm);
		List<DECFareBalanceContent> decRegContent = decFareBalanceContentService.findAll(new DECFareBalanceContent());
