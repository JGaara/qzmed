...
public class DecDrugAdviceDetailTest {
...
/*	@Test
	...
	*/
	...
	public void testFindAll() {
		DECDrugAdviceDetailContentMapper drcm = (DECDrugAdviceDetailContentMapper) 
				SpringBeanUtil.getApplicationContext().getBean(DECDrugAdviceDetailContentMapper.class);
		decDrugAdviceDetailContentService.setMapper(drcm);
		List<DECDrugAdviceDetailContent> decRegContent = decDrugAdviceDetailContentService.findAll(new DECDrugAdviceDetailContent());
